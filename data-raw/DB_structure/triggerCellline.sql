...
-------------------------------------------------------------------------------------
--DROP TRIGGER IF EXISTS updateVersionTrigger on cellline.analysis;
--CREATE OR REPLACE FUNCTION updateVersion() RETURNS "trigger" AS '
--DECLARE
--  versionN INT2;
--BEGIN
--  SELECT INTO versionN max(versionNumber) FROM cellline.version;
--  IF FOUND THEN
...
-------------------------------------------------------------------------------------
DROP TRIGGER IF EXISTS checkInvalidateCurve ON cellline.measuredvalue;
...
-------------------------------------------------------------------------------------
DROP TRIGGER IF EXISTS checkDeleteMeasuredValue ON cellline.measuredvalue; 
